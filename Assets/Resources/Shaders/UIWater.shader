...
Shader "MasterHouse/UIWater"
{
    Properties
    {
        ...
        _WaterColor ("水体色", Color) = (0.42, 0.27, 0.16, 0.85)
        _RippleColor ("波纹亮纹色", Color) = (0.85, 0.68, 0.45, 0.95)
        _FillRadius ("液面半径 0~0.5（代码喂：随进度扩展）", Range(0, 0.5)) = 0
